...
class Report:
    ...
    def generate_report_for_maximum_temperature_in_year(year, all_weather_records):
        maximum_temperature_month, maximum_temperature_day, maximum_temperature = (Computations.
                                                                                   find_maximum_temperature_in_year
                                                                                   (year, all_weather_records))
    ...
    def generate_report_for_minimum_temperature_in_year(year, all_weather_records):
        minimum_temperature_month, minimum_temperature_day, minimum_temperature = (Computations.
                                                                                   find_minimum_temperature_in_year
                                                                                   (year, all_weather_records))
    ...
    def generate_report_for_maximum_humidity_in_year(year, all_weather_records):
        maximum_humidity_month, maximum_humidity_day, maximum_humidity = (Computations.
                                                                          find_maximum_humidity_in_year
                                                                          (year, all_weather_records))
    ...
    def generate_report_for_average_highest_temperature_in_month(year, month, all_weather_records):
        average_highest_temperature_in_month = (Computations.
                                                find_average_highest_temperature_in_month
                                                (year, month, all_weather_records))
    ...
    def generate_report_for_average_lowest_temperature_in_month(year, month, all_weather_records):
        average_lowest_temperature_in_month = (Computations.
                                               find_average_lowest_temperature_in_month
                                               (year, month, all_weather_records))
    ...
    def generate_report_for_average_mean_humidity_in_month(year, month, all_weather_records):
        average_mean_humidity_in_month = (Computations.
                                          find_average_mean_humidity_in_month(year, month, all_weather_records))
        print(f"Average Mean Humidity: {average_mean_humidity_in_month}%")

    @staticmethod
    def generate_barchart(temperature, is_maximum_temperature):
        return "\033[91m {}\033[00m".format(
            "+" * temperature) if is_maximum_temperature else "\033[94m {}\033[00m".format("+" * temperature)
    ...
    def generate_report_for_maximum_minimum_temperature_on_days_in_month(year, month, all_weather_records):
        ...
        for single_day_record in range(len(weather_daily_records)):
            Report.generate_report_for_maximum_minimum_temperature_on_day(year, month, single_day_record,
                                                                          all_weather_records)